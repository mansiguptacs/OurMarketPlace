...
(1, 'Bridal Makeup Package', 'Complete bridal makeup with airbrush finish, hairstyling, and draping.', 299.99, 'assets/img/makeup_bridal.jpg', 'Services'),
(1, 'Party Makeup', 'Glamorous party look with smokey eyes and contouring.', 89.99, 'assets/img/makeup_party.jpg', 'Services'),
...
-- ============================================
INSERT INTO products (company_id, name, description, price, image_url, category) VALUES
(2, 'Kundan Necklace Set', 'Elegant kundan necklace with matching earrings for festive occasions.', 65.00, 'assets/img/jewel_kundan.jpg', 'Necklaces'),
(2, 'Pearl Drop Earrings', 'Delicate pearl drop earrings with gold-plated hooks.', 25.00, 'assets/img/jewel_pearl.jpg', 'Earrings'),
(2, 'Oxidized Silver Bracelet', 'Handcrafted oxidized silver bracelet with traditional motifs.', 30.00, 'assets/img/jewel_bracelet.jpg', 'Bracelets'),
(2, 'Statement Ring - Emerald', 'Bold statement ring featuring emerald-colored stone in antique setting.', 20.00, 'assets/img/jewel_ring.jpg', 'Rings'),
(2, 'Maang Tikka - Bridal', 'Beautiful bridal maang tikka with crystal and pearl detailing.', 35.00, 'assets/img/jewel_tikka.jpg', 'Hair Accessories');
